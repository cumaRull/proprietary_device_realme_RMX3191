...
git clone --depth=1 https://github.com/cumaRull/vendor_realme_RMX3191.git -b oss-rui2 ./vendor/realme/RMX3191
git clone --depth=1 https://github.com/cumaRull/vendor_realme_RMX3191-ims.git -b twelve ./vendor/realme/RMX3191-ims
git clone --depth=1 https://github.com/ArrowOS/android_device_mediatek_sepolicy_vndr.git -b arrow-12.1 ./device/mediatek/sepolicy_vndr
